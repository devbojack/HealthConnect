...
class AuthPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(bottom: 16.0),
      child: isSigningIn ? FancyPasswordField(
        controller: passwordController,
        autovalidateMode: autoValidateMode,
        showPasswordIcon: Icon(Icons.visibility_rounded, size: 18, color: Theme.of(context).dividerColor,),
        hidePasswordIcon: Icon(Icons.visibility_off, size: 18, color: Theme.of(context).dividerColor,),
